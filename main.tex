...
Reservation: (#
  date: @Date;
  DisplayReservation: (# do date.Display; INNER; #)
  Display:< DisplayReservation
#)

TrainReservation: Reservation (#
  seat: @Seat;
  DisplayTrainReservation: DisplayReservation (# do seat.Display; INNER; #)
...
Reservation: (#
  date: @Date;
  Display:< (# do date.Display; INNER; #)
#)

TrainReservation: Reservation (#
  seat: @Seat;
  Display::< (# do seat.Display; INNER; #)
#)
\end{lstlisting}
\end{frame}
