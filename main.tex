...
\begin{explainframe}{\texttt{Sokoban}}
  \begin{itemize}
    \item All class references are relative: relocatable code
    \item Class nesting establishes namespace: no class name clashes
  \end{itemize}
\end{explainframe}
...
\begin{table}
  \centering
  \includegraphics[width=0.7\textwidth]{screenshot_iterator.png}
\end{table}
\end{explainframe}
